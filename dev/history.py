...
class History:
    lvcDirectoryName = '.lvc'


    def __init__(self, directory, ):
        self.directory = directory
        self.lvcDirectoryName 
        self.versions = []
    ...
    # Checks if any history is init in a given directory
    def isInit(self, directory):
        
        return os.path.isdir(os.path.join(directory, self.lvcDirectoryName))
