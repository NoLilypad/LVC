...
class Command:
    def __init__(self, CONFIG):
        ...
        self.lvcDirectory = os.path.join(self.workingDirectory, CONFIG['LVC_DIR'])
        self.dataFilePath = os.path.join(self.workingDirectory, CONFIG['LVC_DIR'], CONFIG['DATA_FILE'])
        self.versionsDirectory = os.path.join(self.workingDirectory, CONFIG['LVC_DIR'], CONFIG['VERSIONS_DIR'])
        self.objectsDirectory = os.path.join(self.workingDirectory, CONFIG['LVC_DIR'], CONFIG['OBJECTS_DIR'])
